...
import com.freemium.singleton.DatasourceEntry;
...
//        com.balimuda.backend.singleton.DatasourceEntryBackend.getInstance().setBackendDS(getDataSource("jdbc/ppobdevds"));
        ...
        DatasourceEntry.getInstance().setMbdatasource(getDataSource("jdbc/pilkadatangselPool"));
        com.agentmanagement.singleton.DatasourceEntryAgentManagement.getInstance().setAgentDS(getDataSource("jdbc/pilkadatangselPool"));
    }
