 ...
 */
public class GetListSubDistrictPolling {

    DatabaseProcess dp = new DatabaseProcess();
    private static final Logger log = Logger.getLogger(GetListSubDistrictPolling.class);

    public HashMap process(HashMap inputMap) {
        try {
            inputMap =  dp.GetListSubDistrict(inputMap);
