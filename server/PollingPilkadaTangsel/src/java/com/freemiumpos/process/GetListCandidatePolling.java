 ...
 */
public class GetListCandidatePolling {

    DatabaseProcess dp = new DatabaseProcess();
    private static final Logger log = Logger.getLogger(GetListCandidatePolling.class);

    public HashMap process(HashMap inputMap) {
        try {
            inputMap =  dp.GetListCandidate(inputMap);
