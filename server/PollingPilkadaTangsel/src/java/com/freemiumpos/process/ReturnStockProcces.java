 ...
 */
public class ReturnStockProcces {
...
//inputMap.get(FieldParameter.refer).toString()
//Integer.valueOf(inputMap.get(FieldParameter.stock).toString())
            if (dp.CheckingReciveStock(inputMap)) {
                if (dp.ReturnStockOutletProduct(inputMap)) {
...
//                inputMap.get(FieldParameter.product_code).toString()
                ...
                inputMap.put(FieldParameter.resp_code, "0001");
                inputMap.put(FieldParameter.resp_desc, "Melebihi batas dari receive stock.");
