...
// */
//public class ListMerchantPrepaid {
//     private static Logger log = Logger.getLogger(ListMerchantPrepaid.class);
//     private Tempmsg tempmsg = new Tempmsg();
//
//    public HashMap process(HashMap input) {
//        DatabaseProcess dp = new DatabaseProcess();
//        HashMap result = dp.getListMerchantPrepaid();
//
...
//            input.put(FieldParameter.listPrepaid, result.get("list"));
//        } else {
