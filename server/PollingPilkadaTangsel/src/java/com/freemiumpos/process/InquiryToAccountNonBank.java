 ...
 * @author adiwibowo
 */
public class InquiryToAccountNonBank {

    private static Logger log = Logger.getLogger(InquiryToAccountNonBank.class);
...
//        if (result.get(RuleNameParameter.resp_code).equals(RuleNameParameter.respcodeSuccess)) {
        ...
        input.put(FieldParameter.name, input.get(FieldParameter.name));
