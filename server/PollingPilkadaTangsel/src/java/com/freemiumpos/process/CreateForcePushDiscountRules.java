 ...
 */
public class CreateForcePushDiscountRules {
...
//            if (inputMap.get(FieldParameter.userlevel).toString().equals("4")) {
                inputMap = dp.CreateForcePushNewDiscountRules(inputMap);
//            } else {
//                inputMap.put(RuleNameParameter.resp_code, "0001");
//                inputMap.put(RuleNameParameter.resp_code, "Permission denied to push discount rules.");
//            }
