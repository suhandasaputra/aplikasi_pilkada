 ...
 */
public class ListOutletProductManage {
     private static Logger log = Logger.getLogger(ListOutletProductManage.class);
     private Tempmsg tempmsg = new Tempmsg();

    public HashMap process(HashMap input) {
        DatabaseProcess dp = new DatabaseProcess();
        HashMap result = dp.getListOutletProductManage(input.get(FieldParameter.fullid).toString(),input.get(FieldParameter.category).toString());
