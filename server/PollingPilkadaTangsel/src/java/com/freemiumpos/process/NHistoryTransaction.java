 ...
 */
public class NHistoryTransaction {
     private static Logger log = Logger.getLogger(NHistoryTransaction.class);
     private Tempmsg tempmsg = new Tempmsg();

    public HashMap process(HashMap input) {
        DatabaseProcess dp = new DatabaseProcess();
        HashMap result = dp.getNListTransaction(input.get(FieldParameter.fullid).toString());
