...
public class InputCandidate {
    ...
    private static final Logger log = Logger.getLogger(InputCandidate.class);
    ...
    public HashMap process(HashMap inputMap) {
        try {
            ...
            inputMap = dp.InputCandidatePolling(inputMap);

            if (inputMap.get(FieldParameter.resp_code).equals("0000")) {

                inputMap.put(RuleNameParameter.resp_desc, "Success Input Candidate");
            } else {
                inputMap.put(RuleNameParameter.resp_code, "0001");
                inputMap.put(RuleNameParameter.resp_desc, "Failed Input Candidate");
