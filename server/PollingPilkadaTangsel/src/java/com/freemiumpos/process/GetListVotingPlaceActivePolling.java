 ...
 */
public class GetListVotingPlaceActivePolling {

    DatabaseProcess dp = new DatabaseProcess();
    private static final Logger log = Logger.getLogger(GetListVotingPlaceActivePolling.class);

    public HashMap process(HashMap inputMap) {
        try {
            inputMap =  dp.GetListVotingPlaceActive(inputMap);
