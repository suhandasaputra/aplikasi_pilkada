 ...
 */
public class NHistoryPoin {
     private static Logger log = Logger.getLogger(NHistoryPoin.class);
     private Tempmsg tempmsg = new Tempmsg();

    public HashMap process(HashMap input) {
        DatabaseProcess dp = new DatabaseProcess();
        HashMap result = dp.getNListPoin(input.get(FieldParameter.userlogin).toString(), 10);
