 ...
 */
public class ListOutletProduct {
     private static Logger log = Logger.getLogger(ListOutletProduct.class);
     private Tempmsg tempmsg = new Tempmsg();

    public HashMap process(HashMap input) {
        DatabaseProcess dp = new DatabaseProcess();
        HashMap result = dp.getListOutletProduct(input.get(FieldParameter.fullid).toString(),input.get(FieldParameter.category).toString());
