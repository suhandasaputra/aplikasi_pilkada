 ...
 */
public class GetVoteReportByDistrict {

    DatabaseProcess dp = new DatabaseProcess();
    private static final Logger log = Logger.getLogger(GetVoteReportByDistrict.class);

    public HashMap process(HashMap inputMap) {
        try {
            inputMap =  dp.GetVoterReportByDistrict(inputMap);
