 ...
 */
public class GetListSubDistrictFromVotingPlaceActivePolling {

    DatabaseProcess dp = new DatabaseProcess();
    private static final Logger log = Logger.getLogger(GetListSubDistrictFromVotingPlaceActivePolling.class);

    public HashMap process(HashMap inputMap) {
        try {
            inputMap =  dp.GetListSubDistrictFromVotingPlaceActive(inputMap);
