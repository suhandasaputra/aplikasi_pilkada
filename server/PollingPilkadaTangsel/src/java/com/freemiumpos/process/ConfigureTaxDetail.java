 ...
 */
public class ConfigureTaxDetail {

    DatabaseProcess dp = new DatabaseProcess();
    private static final Logger log = Logger.getLogger(ConfigureTaxDetail.class);

    public HashMap process(HashMap inputMap) {
        try {
            //save sebelum kirim ke MOST
//            HashMap responseMOST = new HashMap();
            inputMap = dp.getdetailTaxConfiguration(inputMap);
//            if (dp.getListTable(inputMap)) {
