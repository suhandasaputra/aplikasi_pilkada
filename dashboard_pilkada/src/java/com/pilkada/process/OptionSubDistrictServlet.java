 ...
 * @author suhanda
 */
public class OptionSubDistrictServlet extends HttpServlet {

    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(OptionSubDistrictServlet.class);
    DatabaseProcess dp = new DatabaseProcess();

    public OptionSubDistrictServlet() {
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action.equalsIgnoreCase("addvol")) {
            ...
            ArrayList<Opt_subdistict> listBank = new ArrayList<>();
            listBank = dp.getAllsubdistrict(district);
            Gson gson = new Gson();
            ...
            ArrayList<Opt_subdistict> listBank = new ArrayList<>();
            listBank = dp.getAllsubdistrictAct();
            Gson gson = new Gson();
            JsonElement element = gson.toJsonTree(listBank);
            JsonArray jsonArray = element.getAsJsonArray();
            response.setContentType("application/json");
