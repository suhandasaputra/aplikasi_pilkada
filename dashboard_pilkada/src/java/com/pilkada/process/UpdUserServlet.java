...
public class UpdUserServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String id_candidate = gg.get("id_candidate_edit").toString();
        String candidate_name_edit = gg.get("candidate_name_edit").toString();
        String img_candidate = gg.get("img_candidate").toString();

        HashMap req = new HashMap();
        MessageProcess mp = new MessageProcessImpl();
        HTTPProcessImpl ht = new HTTPProcessImpl();
        req.put("procCode", "50016");
        req.put("candidate_id", id_candidate);
        req.put("candidate_name", candidate_name_edit);
