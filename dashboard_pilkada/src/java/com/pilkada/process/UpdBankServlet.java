...
public class UpdBankServlet extends HttpServlet {
...
//
//        String bankcode = gg.get("bankcode_edit").toString();
//        String bankname = gg.get("bankname_edit").toString();
//        
//        String status = dp.updateBank(bankcode, bankname);
//
