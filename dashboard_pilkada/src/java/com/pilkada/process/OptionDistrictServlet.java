 ...
 * @author suhanda
 */
public class OptionDistrictServlet extends HttpServlet {

    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(OptionDistrictServlet.class);
    DatabaseProcess dp = new DatabaseProcess();

    public OptionDistrictServlet() {
    }

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ArrayList<Opt_distict> listBank = new ArrayList<>();
        listBank = dp.getAlldistrict();
        Gson gson = new Gson();
