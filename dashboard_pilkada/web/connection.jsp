                                                    ...
                                                    <div id="category" class="tab-pane fade in active show">
                                                        ...
                                                        <div class="container">        
                                                            <table class="table" id="table_conn">
                                                                <thead>
                                                                    <tr>
                                                                        <th>id voting place</th>
                                                                        <th>voting place name</th>
                                                                    </tr>
                                                                </thead>
                                                            </table>
                                                        </div>
                                                        <%@include file='pop_up_add_conn1.jsp'%>
                                                        <%@include file='pop_up_edit_conn1.jsp'%>
                                                    </div>
                                                </div>    
                                            </div>
                                            <!-- /.row -->
